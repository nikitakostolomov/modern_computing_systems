import os
from tkinter import (HORIZONTAL, Button, Canvas, Entry, Frame, Label, N,
                     OptionMenu, Scrollbar, StringVar, W)
...
class ResearchFrame(Frame):
    ...
    def run_research(self) -> None:
        ...
        best_scores, _, _ = research(
            self.__state["database"].get(),
            self.__state["method"].get(),
            int(self.__state["train_count"].get()),
        )
        self.result_images = []
